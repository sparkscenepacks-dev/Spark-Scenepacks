...
app.post(['/api/scenepacks', '/api/scenepacks/', '/scenepacks', '/scenepacks/'], isAuthenticated, async (req, res) => {
    try {
        ...
        const payload = {
            ...
            tags: Array.isArray(scenepackData.tags) ? scenepackData.tags : (scenepackData.tags ? scenepackData.tags.split(',').map(t => t.trim()) : []),
...
async function sendDiscordNotification(scenepack) {
    ...
    try {
        ...
        const embed = {
            ...
            thumbnail: { url: 'https://sparkscenepacks.vercel.app/assets/spark-logo-white.png' },
            footer: { 
                text: 'Spark Scenepacks | Premium Quality Scenes',
                icon_url: 'https://sparkscenepacks.vercel.app/assets/spark-logo-white.png'
            },
            timestamp: new Date()
        };
